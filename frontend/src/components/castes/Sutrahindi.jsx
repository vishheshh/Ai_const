  ...
  return (
    ...
    <div className="w-full h-auto">
      ...
      <div className="w-full h-screen mt-4 flex flex-col sm:flex-row justify-evenly items-center py-2 px-20 border-2 border-[#776B5D] rounded-xl">
        <div className="w-2/5">
          <img
            src={`/${casteDetails.religion}_castes/${casteDetails.name}_images/${casteDetails.name}_Sutra_hindi.png`}
        ...
        <div className="relative flex flex-col w-3/5 mt-4 ">
          <img
            src={`/${casteDetails.religion}_castes/${casteDetails.name}_images/${casteDetails.name}_Sutra_truth_meter.png`}
            className=""
            alt=""
            loading="lazy"
          />
              ...
              <div className="flex">
                ...
                <div className="prompt w-2/3 font-semibold bg-[#ECECEC] rounded-xl ml-auto p-4">
                  ...
                  <p>
                    {
                      [
                        "निम्नलिखित वाक्य में MASKED शब्द के स्थान पर मूल धर्म का नाम केवल धर्म की जड़ नाम के रूप में शीर्ष 1 सबसे उपयुक्त धर्म नाम बुलेट बिंदु में प्रदान करें, यह सुनिश्चित करते हुए कि नाम केवल हिंदी भाषा में प्रस्तुत किए जाएं और किसी भी श्रेणी या जाति संदर्भ को शामिल न करें।",
                        "पुनः लिखें, विभिन्न विकल्पों का अन्वेषण करें, तौलें और मूल्यांकन करें, और शीर्ष 1 सबसे उपयुक्त मूल धर्म के नाम से MASKED शब्द को भरें।",
                        "वर्णन को परिष्कृत करें, ध्यान से देखें और MASKED शब्द को भरकर शीर्ष 1 सबसे उपयुक्त मूल धर्म का नाम बुलेट प्वाइंट्स में दें।",
              ...
              <div className="response text-[#] mt-4 flex gap-2">
                ...
                <div className="flex flex-col">
                  <ul className="list-disc ml-6">
                    <li>{row[10]}</li> {/* Column K */}
                    <li>{row[11]}</li> {/* Column L */}
                    <li>{row[12]}</li> {/* Column M */}
                    <li>{row[13]}</li> {/* Column N */}
                    <li>{row[14]}</li> {/* Column O */}
                  </ul>
                </div>
              </div>
            </div>
